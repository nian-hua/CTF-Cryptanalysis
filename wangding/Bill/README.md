...
````
看到密文样式后，猜测为简单替换加密，使用在线脚本https://github.com/nian-hua/cryptography/blob/master/substitution/Quadgram/hill.py对其进行解密
...
````
fgal{0a8e5b6884c0247324ad3b36a9df144a6b836d4f37055b6883b37e6e39d4c64b66a3afd9a44aa0}
flag
所以首先将大括号内的数字字母进行换序，可以使用以下脚本：

ff = input("flag:")
for i in range(len(ff)//4):
    nianhua = ''
    test = ff[4*i:4*i+4]
    nianhua = test[:1] +  test[-1:] + test[2:3] + test[1:2]
    print (nianhua,end='')

````
换位之后的flag为：flag{0e8a586b80c423742da4363bafd91a44638b6f4d3507586b83b37e6e34d9cb4663a6a9dfaa44a0}</br>
题目提示比尔密码，因此猜测此字符串表示多个十六进制数字。</br>
例如0e，表示第0x0e个单词的首字母(从0开始)</br>
    8a，表示第0x8a个单词的首字母(依此类推)
    ····
